			...
			<div class="col-md-12">
				...
				<div class="order3 col-md-6 py-5">
					<div class="order col-md-2">
						<span class="num1 text-muted">01</span> 
						<span class="numtitle1 text-muted">&nbsp;장바구니</span>
					</div>

					<div class="order col-md-2">
						<span class="font-weight-bold"><strong> > </strong></span> 
						<span class="num2"><strong>02</strong></span> 
						<span class="numtitle2"><strong>&nbsp;주문/결제</strong></span>
					</div>
	...
	<div class="container">
		...
		<br>
			...
			<div class="row col-md-12 m-0">
				...
				<% if(pList.isEmpty()) {%>
					<img src="<%=request.getContextPath()%>/resources/appoimg/no_img.png" id="no_img">
					<span> 결제할 상품이 없습니다.</span>
					<% } else {%>
                    	<% for(Cart cart : cList){ %>
	                    	<% if (cart.getImagePath()==null){ %> 
							<img src="<%=request.getContextPath()%>/resources/appoimg/no_img.png" id="no_img">
							<% } else { %>
							<img src="<%=request.getContextPath()%>/resources/appoimg/5x5.png" id="img5x5">
							<% } %>
						<% } %>
				...
				<div>
					<% for(Product product : pList){ %>
						<span id="producttitle" name="producttitle">&nbsp;&nbsp;<%=product.getProductTitle() %></span> 
						<span id="producttxt"> 상품을 주문합니다.</span><br> 
						<span class="productstatus">상품번호 :</span> 
						<span class="detailtxt"><%=product.getProductNo() %></span><br>
					<% } %>
				<% } %>
				</div>
			</div>
		...
		<div class="container">
			...
			<form>
				<fieldset>
					<div class="form-group mb-0 ml-5">
						...
						<select class="form-control-sm" id="deliverySelect">
						...
						<div class="modal-body">
							...
							<form>
								<div class="card border-primary mb-3" style="max-width: auto;"
									id="delivery1">
									<div class="card-header font-weight-bold" id="deltitle">KH 정보교육원 종로지원</div>
									<div class="card-body">
										<input type="text" class="form-control" id="name" placeholder="이름 입력" required></input><br>
										<div class="row mb-3 form-row">
											<div class="col-md-3">
												<input type="text" name="post" class="form-control postcodify_postcode5" id="post-1" placeholder="우편번호" required>
											</div>
											<div class="col-md-3">
												<button type="button" class="btn btn-primary" id="postcodify_search_button1">검색</button>
											</div>
										</div>
	
										<div class="row mb-3 form-row">
											<div class="col-md-9">
												<input type="text" class="form-control postcodify_address" name="address1" id="address1-1" placeholder="주소를 입력하세요"
													required>
											</div>
										</div>
							...
							<form>
								<div class="card border-primary mb-3" style="max-width: auto;"
									...
									<div class="card-body">
										...
										<div class="row mb-3 form-row">
											<div class="col-md-3">
												<input type="text" name="post" class="form-control postcodify_postcode5" id="post-2"
										...
										<input type="number" class="form-control" id="phone"
											placeholder="휴대전화번호를 입력하세요" required></input><br> 
										<input type="text" class="form-control" id="delmag"
											placeholder="배송요청 메세지를 입력하세요"></input><br>
									</div>
									<button type="button" class="btn btn-outline-secondary btn-sm">저장</button>
									<button type="submit" class="btn btn-primary btn-sm"
			...
			<form class="needs-validation" novalidate>
				...
				<div class="col-md-12">
					<span class="mr-5 ml-3">상품정보</span> 
					<span class="pull-right text-muted ml-5 mr-3">배송비</span> 
					<span class="pull-right text-muted ml-5">상품금액</span> 
					<span class="pull-right text-muted">판매자명</span>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<!-- 배송비 -->
						<span class="pull-right mr-3 ml-5 mt-4 pt-2">3000</span> 
						<!-- 상품금액 -->
						<span class="pull-right mr-3 ml-5 mt-4 pt-2"></span> 
						<!-- 판매자 -->
						<span class="pull-right mr-4 ml-5 mt-4 pt-2"></span>
					</div>
						<% } %>
				...
				<div class="col-md-12">
					<span class="pull-right ml-5 mr-2"></span>5555555
					<span class="pull-right">상품금액</span><br> 
					<span class="pull-right ml-5 mr-2"></span>3000 
					<span class="pull-right mr-3">배송비</span>
				</div>
				<br>
				<hr id="hrcss">
				...
				<div>
					...
					<span class="totalprice font-weight-bold pull-right mr-2">5970805</span>
				</div>
			<% } %>
			<hr id="hrcss">
			<br> <br> <br>
			...
			<div class="col-md-12">
				...
				<form>
					...
					<input type="radio" id="bankdeposit"> 
